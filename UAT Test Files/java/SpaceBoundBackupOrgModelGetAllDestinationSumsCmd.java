 ...
 * @author bmcguire
 */
public class SpaceBoundBackupOrgModelGetAllDestinationSumsCmd extends AbstractCmd<Map<Long, AggregateBackupStats>> {
	...
	public SpaceBoundBackupOrgModelGetAllDestinationSumsCmd(Map<Long, AggregateBackupStats> model) {
	...
	public Map<Long, AggregateBackupStats> exec(CoreSession session) throws CommandException {
		...
		return SpaceBoundModelUtils.sumOrgSpaceModel(this.model, this.relation.getSpaceDestinationMappings());
	}
}
