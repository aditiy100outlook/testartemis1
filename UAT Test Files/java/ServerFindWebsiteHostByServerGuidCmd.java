...
public class ServerFindWebsiteHostByServerGuidCmd extends DBCmd<URL> {

	private long serverGuid;

	public ServerFindWebsiteHostByServerGuidCmd(long serverGuid) {
		super();
	...
	public URL exec(CoreSession session) throws CommandException {
		...
		final BaseServer server = this.db.find(new BaseServerFindByGuidQuery(this.serverGuid));
